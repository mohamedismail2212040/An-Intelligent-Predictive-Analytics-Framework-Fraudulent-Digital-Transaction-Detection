...
URL          : https://www.kaggle.com (Search: synthetic UPI fraud transaction dataset)
...
Label Format : filename  total_frames  fps  suspicious_start_frame  suspicious_end_frame
...
Prerequisite Setup:
  ...
  3. Upload the ATMA-V Dataset folder to your Google Drive (Required only for ATM notebooks)
  4. Upload the dataset CSV files to Google Drive or directly to Colab session storage
...
Steps to Run Each Notebook:
  ...
  5. Upload dataset file:
       For CC notebooks  : Upload fraudTrain.csv (Click folder icon on left > Upload)
       For UPI notebooks : Upload synthetic_fraud_dataset.csv
       For ATM notebooks : Mount Google Drive (Cell 1 will do this automatically)
...
Step 5 - Run the Notebook:
  ...
  3. Click Run All (or run cells one by one using the play button)
...
DOMAIN 1: CREDIT CARD FRAUD DETECTION
  ...
  Step 1 : PP3CC_DL_8_2.ipynb
    ...
    Preprocessing         : TruncatedSVD (48937 features reduced to 50)
    Results:
  ...
  Step 2 : PP3CC_ML_8_2.ipynb
    ML models             : Logistic Regression, Linear Regression, KNN, XGBoost, LightGBM
...
DOMAIN 2: UPI FRAUD DETECTION
  ...
  Step 3 : PP3UPI_DL_8_2.ipynb
    ...
    Preprocessing         : TruncatedSVD (110119 features reduced to 50)
    Results:
  ...
  Step 4 : PP3UPI_ML_8_2.ipynb
    ML models             : Logistic Regression, Linear Regression, KNN, XGBoost, LightGBM, SVM
    Dataset               : synthetic_fraud_dataset.csv (50,000 records)
    Preprocessing         : TruncatedSVD (110084 features reduced to 50)
    Results:
  ...
  Step 6 : UPI_AD__1_.ipynb
    ...
    Dataset               : synthetic_fraud_dataset.csv (50,000 records)
    Preprocessing         : TruncatedSVD (110019 features reduced to 50)
...
DOMAIN 3: ATM SURVEILLANCE
  ...
  Step 8 : ATM2.ipynb
    ...
    Inpainting Model      : Stable Diffusion Inpainting (runwayml/stable-diffusion-inpainting)
...
Steps:
  ...
  5. Right-click FYP.html in the Explorer panel
...
Features of the Viewer:
  ...
  Download any notebook as .ipynb for VS Code
       ...
       Best Model : CNN+BiLSTM (Accuracy: 100%)
       ResNet50 Frame Classifier : Test Accuracy 99.88%
       Real-time face detection and inpainting implemented
