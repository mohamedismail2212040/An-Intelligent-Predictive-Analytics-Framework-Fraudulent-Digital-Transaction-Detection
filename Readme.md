...
DATASET 1 : CREDIT CARD FRAUD DATASET
  ...
  Download Steps:
    • Step 1 : Go to https://www.kaggle.com/datasets/kartik2112/fraud-detection
...
OPTION 1 : RUN ON GOOGLE COLAB (RECOMMENDED)
  ...
  Prerequisite Setup:
    • Step 1 : Create a Google account at https://accounts.google.com
...
HOW TO RUN THE NOTEBOOK VIEWER WEBSITE
  ...
  Steps:
    ...
    • Step 7 : Browser opens at http://127.0.0.1:5500/FYP.html
...
PROJECT SUMMARY
  ...
  1. Credit Card Fraud Detection
       • 1,296,675 real-world transactions analysed
       • Best Model : GRU (Accuracy: 95.07%, ROC-AUC: 0.9849)

  2. UPI Fraud Detection
       • 50,000 synthetic UPI transactions analysed
       • Best Deep Learning Model : LSTM / GRU (Accuracy: 99.66%)
       • Best Machine Learning Model : SVM (Accuracy: 98.06%)

  3. ATM Surveillance System
       • 65 surveillance videos analysed (ATMA-V dataset)
